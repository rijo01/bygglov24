...
Avgiften följer av formler i 9 kap. PBF. **Sanktionsarean är åtgärdens brutto- eller öppenarea minskad med 15 kvadratmeter** (9 kap. 1 § PBF). Räkneexemplen nedan avser en- eller tvåbostadshus och 2026 års prisbasbelopp (PBB), 59 200 kr:

| Åtgärd | Formel enligt PBF | Räkneexempel 2026 |
|---|---|---|
| Tillbyggnad utan startbesked, 20 m² (9 kap. 7 §) | 0,5 × PBB + 0,005 × PBB × sanktionsarea | 0,5 × 59 200 + 0,005 × 59 200 × 5 = **31 080 kr** |
| Nybyggnad av lovpliktig komplementbyggnad, 40 m² (9 kap. 6 §) | 0,25 × PBB + 0,005 × PBB × sanktionsarea | 0,25 × 59 200 + 0,005 × 59 200 × 25 = **22 200 kr** |
| Fasadändring (9 kap. 10 §) | 0,125 × PBB + 0,0005 × PBB × berörd area | 0,125 × 59 200 = **7 400 kr** plus arealtillägg |
| Rivning av huvudbyggnad, 130 m² (9 kap. 15 §) | 1 × PBB + 0,002 × PBB × sanktionsarea | 59 200 + 0,002 × 59 200 × 115 = **72 816 kr** |
